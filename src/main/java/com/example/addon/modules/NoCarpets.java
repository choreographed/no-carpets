...
private final Setting<Boolean> noCarpets = sgWorld.add(new BoolSetting.Builder()
    .name("carpets")
    .description("Disables rendering of carpets.")
    .defaultValue(false)
    .build()
   );
    ...
    public boolean noCarpets() {
    return isActive() && noCarpets.get();
    }
